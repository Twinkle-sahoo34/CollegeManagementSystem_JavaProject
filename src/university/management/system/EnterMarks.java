...
public class EnterMarks extends JFrame  implements ActionListener {
    ...
    EnterMarks() {
        ...
        // Populate roll numbers from DB
        try {
            Conn c = new Conn(); // Ensure 'Conn' class is defined properly
        ...
        // TextFields for Marks
        tfmarks1 = new JTextField();
        tfmarks1.setBounds(300, 200, 200, 20);
        add(tfmarks1);

        tfmarks2 = new JTextField();
        tfmarks2.setBounds(300, 230, 200, 20);
        add(tfmarks2);

        tfmarks3 = new JTextField();
        tfmarks3.setBounds(300, 260, 200, 20);
        add(tfmarks3);

        tfmarks4 = new JTextField();
        tfmarks4.setBounds(300, 290, 200, 20);
        add(tfmarks4);

        tfmarks5 = new JTextField();
        tfmarks5.setBounds(300, 320, 200, 20);
        add(tfmarks5);
...
submit = new JButton("Submit");
        submit.setBounds(70, 360, 200, 20);
